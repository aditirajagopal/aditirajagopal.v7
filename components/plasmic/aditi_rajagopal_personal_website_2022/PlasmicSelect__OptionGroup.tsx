...
import * as sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: QM42q9zfuJB/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: jvp3Zw0Hsia/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option___0BlIa)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__jiakK)}
              />
            </React.Fragment>
          ),
          value: args.children
